...
wget https://github.com/binwiederhier/replbot/releases/download/v0.2.0/replbot_0.2.0_amd64.deb
dpkg -i replbot_0.2.0_amd64.deb
```

**Fedora/RHEL/CentOS:**
```bash
# Make sure that "tmux" is installed
rpm -ivh https://github.com/binwiederhier/replbot/releases/download/v0.2.0/replbot_0.2.0_amd64.rpm
```
...
```bash
# Make sure that "tmux" is installed
wget https://github.com/binwiederhier/replbot/releases/download/v0.2.0/replbot_0.2.0_linux_x86_64.tar.gz
sudo tar -C /usr/bin -zxf replbot_0.2.0_linux_x86_64.tar.gz replbot
```
